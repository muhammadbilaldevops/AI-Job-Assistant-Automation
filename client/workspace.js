...
function welcome() {
  if (!AUTH_ENABLED) return `<div class="welcome"><a class="brand" href="/">a<span>applydesk<span class="brand-dot">.</span></span></a><div class="auth-paused"><span class="pill">AUTHENTICATION PAUSED</span><h1>Private workspace<br><em>opening soon.</em></h1><p>Sign in and account creation are temporarily hidden while production email delivery is configured.</p></div><footer>BUILT FOR YOUR NEXT OPPORTUNITY <span>Your workspace will return when authentication is ready.</span></footer></div>`;

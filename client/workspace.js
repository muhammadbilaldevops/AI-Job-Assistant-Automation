...
function welcome() {
  if (!AUTH_ENABLED) return `<div class="welcome"><a class="brand" href="/">a<span>applydesk<span class="brand-dot">.</span></span></a><div class="auth-paused"><span class="pill">APPLYDESK WORKSPACE</span><h1>Your career story<br><em>starts here.</em></h1><p>Your private career workspace is being prepared. Job discovery, matching and application tools will appear here soon.</p></div><footer>BUILT FOR YOUR NEXT OPPORTUNITY <span>A thoughtful job search, one step at a time.</span></footer></div>`;
